...
def generate():
    ...
    contents = [
        types.Content(
            role="user",
            parts=[
                types.Part.from_text(text="""System instructions: Read aloud in a warm, welcoming tone; vibe is optimistic and forward-looking as we discuss how AI and sustainability are reshaping the organic coffee experience. Keep the pacing conversational and engaging.
